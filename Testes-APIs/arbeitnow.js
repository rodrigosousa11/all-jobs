...
function searchInArbeitnow(searchString) {
	...
	fetch("https://www.arbeitnow.com/api/job-board-api", requestOptions)
		...
		.then(result => {
			// Store the data from the API in the data variable
			data = result.data;
			// Search in the data and store the results in the results variable
			results = searchInData(searchString);
			// Return the search results
			return results;
		})
		// Log any error that occurs during the fetch or search
